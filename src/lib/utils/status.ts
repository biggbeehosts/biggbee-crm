...
export const STATUS_COLORS: Record<LeadStatus, { bg: string; text: string; dot: string }> = {
  Staged: { bg: "bg-slate-500/15", text: "text-slate-300", dot: "bg-slate-400" },
  ...
  "Not Interested": { bg: "bg-slate-500/15", text: "text-slate-400", dot: "bg-slate-500" },
  ...
  Unsubscribed: { bg: "bg-slate-600/15", text: "text-slate-400", dot: "bg-slate-500" },
