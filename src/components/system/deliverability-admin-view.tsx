    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={summary.inboxPlacementRate === null ? "—" : `${Math.round(summary.inboxPlacementRate * 100)}%`}
          hint={summary.inboxPlacementRate === null ? "No placement data recorded yet" : undefined}
          icon={Inbox}
        />
      </div>
        ...
        <Card>
          <CardHeader>
            <div>
              ...
              <CardDescription>Record placement results from seed tests or external deliverability testing</CardDescription>
            </div>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          {byProvider.length === 0 ? (
            <EmptyState
              icon={Inbox}
              title="No placement tests recorded"
              description="Record placement results from seed tests or external deliverability testing."
            />
          ) : (
